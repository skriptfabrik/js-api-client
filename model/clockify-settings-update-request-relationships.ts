 ...
 * 
 * @export
 * @interface ClockifySettingsUpdateRequestRelationships
 */
export interface ClockifySettingsUpdateRequestRelationships {
    /**
     * 
     * @type {OrganizationRelationship}
     * @memberof ClockifySettingsUpdateRequestRelationships
     */
