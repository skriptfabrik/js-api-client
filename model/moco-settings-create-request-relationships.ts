 ...
 * 
 * @export
 * @interface MocoSettingsCreateRequestRelationships
 */
export interface MocoSettingsCreateRequestRelationships {
    /**
     * 
     * @type {OrganizationRelationship}
     * @memberof MocoSettingsCreateRequestRelationships
     */
