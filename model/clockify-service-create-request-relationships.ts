 ...
 * 
 * @export
 * @interface ClockifyServiceCreateRequestRelationships
 */
export interface ClockifyServiceCreateRequestRelationships {
    /**
     * 
     * @type {OrganizationRelationship}
     * @memberof ClockifyServiceCreateRequestRelationships
     */
