 ...
 * 
 * @export
 * @interface ClockifySettingsCreateRequestRelationships
 */
export interface ClockifySettingsCreateRequestRelationships {
    /**
     * 
     * @type {OrganizationRelationship}
     * @memberof ClockifySettingsCreateRequestRelationships
     */
