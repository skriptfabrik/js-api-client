 ...
 * 
 * @export
 * @interface MocoSettingsUpdateRequestRelationships
 */
export interface MocoSettingsUpdateRequestRelationships {
    /**
     * 
     * @type {OrganizationRelationship}
     * @memberof MocoSettingsUpdateRequestRelationships
     */
